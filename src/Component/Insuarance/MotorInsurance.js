        ...
        <div className={usestyles.root}>
            ...
            <div className="relative overflow-hidden">
                ...
                <img
                    ...
                    src="assets/insurance/motor_insurance_header.jpg"
                    alt="Services Header"
                />
                {/* Text Overlay */}
                <div className="absolute inset-0 flex items-center justify-center text-white bg-black bg-opacity-50">
                    <h1 className="text-4xl font-bold text-center">Motor Insurance </h1>
                </div>
            </div>
            ...
            <Container className={usestyles.contentSection}>
                <Grid container spacing={3} sx={{ marginTop: { xs: 2, sm: 2 } }}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ order: { xs: 2, sm: 2, md: 1 } }}>
                        ...
                        Motor insurance, also known as auto insurance or car insurance, is a type of general insurance that provides financial protection to vehicle owners against losses or damages incurred due to accidents, theft, or other covered perils.
                         Motor insurance is mandatory in many countries and is designed to protect both the vehicle owner and third parties affected by accidents involving the insured vehicle. 
                          </Typography>
                        <Typography variant="body1" paragraph>
                    ...
                    <Grid item xs={12} sm={12} md={6} sx={{ order: { xs: 1, sm: 1, md: 2 } }} >
                        <img
                            src="assets/insurance/motor-insurance-banner-img-new.png"
                            alt="Right Content"
                            sx={{
                                width: '100%',
                                height: 'auto',
            ...
            <Container className={usestyles.contentSection}>
                <Grid container spacing={3} sx={{ marginTop: { xs: 2, sm: 2 } }}>
                    <Grid item xs={12} sm={12} md={6} sx={{ marginTop: { xs: 2, sm: 2 } }} >
                        <img
                            src="assets/insurance/cheapest-for-car-insurance.webp"
                            alt="Right Content"
                            sx={{
                                width: '100%',
                                height: 'auto',
                    ...
                    <Grid item xs={12} sm={6} sx={{ marginTop: { xs: 2, sm: 2 } }}>
                        <Typography variant="h5" gutterBottom>
                            ...
                            Key Benefits of Motor insurance plans
                        </Typography>
                        <Typography variant="body1" paragraph>
                          Motor insurance plans offer several key benefits
                        </Typography>
                        <ul sx={{
                            listStyleType: 'disc',
            ...
            <Container className={usestyles.contentSection}>
                <Grid container spacing={3} sx={{ marginTop: { xs: 2, sm: 2 } }}>
                    ...
                    <Grid item xs={12} sm={6}>
                        <Typography variant="h5" gutterBottom>
                            Documents required For Motor Insurance Plan
                        </Typography>
                        <Typography variant="body1" gutterBottom>


                            The specific documents required for Motor insurance may vary depending on the type of insurance and the insurance provider    </Typography>
                        <ul sx={{
                            listStyleType: 'disc',
                        ...
                        <ul sx={{
                            ...
                            <li style={{ marginBottom: '1rem' }}>
                                <span style={{ fontWeight: 'semi-bold', fontSize: '1rem', display: 'flex', alignItems: 'center' }}>
                                    ...
                                    1.Navi General Insurance Limited
                                </span>
                            </li>
                            ...
                            <li style={{ marginBottom: '1rem' }}>
                                <span style={{ fontWeight: 'semi-bold', fontSize: '1rem', display: 'flex', alignItems: 'center' }}>
                                    ...
                                    4.Kotak Mahindra General Insurance Company Limited
                                </span>
                            </li>
                            ...
                            <li style={{ marginBottom: '1rem' }}>
                                <span style={{ fontWeight: 'semi-bold', fontSize: '1rem', display: 'flex', alignItems: 'center' }}>
                                    ...
                                    7.Royal Sundaram General Insurance Company Limited
                                </span>
                            </li>
                            ...
                            <li style={{ marginBottom: '1rem' }}>
                                <span style={{ fontWeight: 'semi-bold', fontSize: '1rem', display: 'flex', alignItems: 'center' }}>
                                    ...
                                    8.Universal Sompo General Insurance Company Limited
                                </span>
                            </li>
                            ...
                            <li style={{ marginBottom: '1rem' }}>
                                <span style={{ fontWeight: 'semi-bold', fontSize: '1rem', display: 'flex', alignItems: 'center' }}>
                                    ...
                                    10.Future Generali India Insurance Company Limited
